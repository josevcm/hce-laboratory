...
DesfireDeleteFile::DesfireDeleteFile(Instance &bundle) : Command(bundle)
{
}

int DesfireDeleteFile::process(rt::ByteBuffer &request, rt::ByteBuffer &response)
{
   LOG_INFO(log, "deleteFile");
