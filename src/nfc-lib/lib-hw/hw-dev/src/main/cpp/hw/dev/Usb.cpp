...
struct Usb::Impl
{
   ...
   {
      LOG_DEBUG(log, "created UsbDevice");
   ...
   ~Impl()
   {
      LOG_DEBUG(log, "destroy UsbDevice");
   ...
   bool open()
   {
      ...
      LOG_DEBUG(log, "starting event handling thread");
